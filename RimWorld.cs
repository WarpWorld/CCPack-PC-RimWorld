...
public class RimWorld : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override EffectList Effects { get; } = new Effect[]
    {
        ...
        new("Give 1000 Corn", "giveitem_RawCorn_1000") { Image = "givefood", Category = "Give Items" , Description = "", Price = 100 },
        ...
        new("Give 1000 Cow Meat", "giveitem_Meat-Cow_1000") { Image = "givefood", Category = "Give Items" , Description = "", Price = 100 },
        ...
        new("Give 500 Wood", "giveitem_WoodLog_500") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 75 },
        new("Give 50 Steel", "giveitem_Steel_50") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 15 },
        new("Give 500 Steel", "giveitem_Steel_500") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 75 },
        ...
        new("Give 1000 Silver", "giveitem_Silver_1000") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 100 },
        ...
        new("Give Prosthetic Arm", "giveitem_SimpleProstheticArm_1") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 75 },
        new("Give Prosthetic Leg", "giveitem_SimpleProstheticLeg_1") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 75 },
        new("Give Bionic Arm", "giveitem_BionicArm_1") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 150 },
        new("Give Bionic Leg", "giveitem_BionicLeg_1") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 150 },
        new("Give Bionic Eye", "giveitem_BionicEye_1") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 125 },
        new("Give Bionic Spine", "giveitem_BionicSpine_1") { Image = "giveitem", Category = "Give Items" , Description = "", Price = 200 },
        ...
        new("Volcanic Winter", "setweather_VolcanicWinter") { Category = "Weather" , Description = "Trigger a volcanic winter on the colony map.", Price = 250 },
        new("Toxic Fallout", "setweather_ToxicFallout") { Category = "Weather" , Description = "Trigger toxic fallout on the colony map.", Price = 250 },
        new("Blood Rain", "setweather_BloodRain") { Note = "Requires Anomaly", Category = "Weather" , Description = "Trigger blood rain on the colony map. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 250 },
        new("Gray Pall", "setweather_GrayPall") { Note = "Requires Anomaly", Category = "Weather" , Description = "Trigger gray pall on the colony map. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 250 },
        ...
        new("Resurrect All Dead Colonists", "resurrectallcolonists") { Category = "Colonists" , Description = "Resurrect every dead colonist.", Price = 500 },
        new("Give Sanguophage Colonist", "xenotyperecruit_Sanguophage") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Sanguophage recruit joins the colony with the player's primary ideology. Note: This effect will fail if the player does not have the Biotech DLC enabled.", Price = 250 },
        new("Give Genie Colonist", "xenotyperecruit_Genie") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Genie recruit joins the colony with the player's primary ideology. Note: This effect will fail if the player does not have the Biotech DLC enabled.", Price = 150 },
        new("Give Hussar Colonist", "xenotyperecruit_Hussar") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Hussar recruit joins the colony with the player's primary ideology. Note: This effect will fail if the player does not have the Biotech DLC enabled.", Price = 200 },
        new("Give Neanderthal Colonist", "xenotyperecruit_Neanderthal") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Neanderthal recruit joins the colony with the player's primary ideology. Note: This effect will fail if the player does not have the Biotech DLC enabled.", Price = 150 },
        new("Give Impid Colonist", "xenotyperecruit_Impid") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Impid recruit joins the colony with the player's primary ideology. Note: This effect will fail if the player does not have the Biotech DLC enabled.", Price = 150 },
        new("Give Yttakin Colonist", "xenotyperecruit_Yttakin") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Yttakin recruit joins the colony with the player's primary ideology. Note: This effect will fail if the player does not have the Biotech DLC enabled.", Price = 150 },
        ...
        new("Colony Wide Mood Boost", "colonywidemoodboost") { Category = "Colonists" , Description = "Boost the mood of every colonist in the colony.", Price = 150 },
        new("Instant Grow Crops", "instantgrowcrops") { Category = "Colonists" , Description = "Instantly mature all planted harvestable crops on the colony map.", Price = 100 },
        ...
        new("Send Friendlies", "friendlyreinforcements") { Category = "Event" , Description = "A friendly faction sends reinforcements to support the colony.", Price = 200 },
        new("Void Provocation", "triggerincident_VoidCuriosity") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger the Void Curiosity incident that begins the path toward void provocation. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 150 },
        new("Creepy Joiner Event", "triggerquest_CreepJoinerArrival") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger a creepy joiner arrival quest. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 200 },
        new("Random Monolith Event", "randommonolithevent") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger a random monolith-related anomaly event. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 200 },
        new("Receive Unknown Cargo Quest", "triggerincident_ResourcePodCrash") { Category = "Event" , Description = "Trigger a cargo pod crash near the colony. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 100 },
        new("Deathpall", "triggerincident_DeathPall") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger the deathpall event. Note: This effect will fail if the player does not have the Anomaly DLC enabled.", Price = 300 },
