...
public class RimWorld : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override EffectList Effects { get; } = new Effect[]
    {
        ...
        new("Blood Rain", "setweather_BloodRain") { Note = "Requires Anomaly", Category = "Weather" , Description = "Trigger blood rain on the colony map.", Price = 250 },
        new("Gray Pall", "setweather_GrayPall") { Note = "Requires Anomaly", Category = "Weather" , Description = "Trigger gray pall on the colony map.", Price = 250 },
        ...
        new("Give Sanguophage Colonist", "xenotyperecruit_Sanguophage") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Sanguophage recruit joins the colony with the player's primary ideology.", Price = 250 },
        new("Give Genie Colonist", "xenotyperecruit_Genie") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Genie recruit joins the colony with the player's primary ideology.", Price = 150 },
        new("Give Hussar Colonist", "xenotyperecruit_Hussar") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Hussar recruit joins the colony with the player's primary ideology.", Price = 200 },
        new("Give Neanderthal Colonist", "xenotyperecruit_Neanderthal") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Neanderthal recruit joins the colony with the player's primary ideology.", Price = 150 },
        new("Give Impid Colonist", "xenotyperecruit_Impid") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Impid recruit joins the colony with the player's primary ideology.", Price = 150 },
        new("Give Yttakin Colonist", "xenotyperecruit_Yttakin") { Note = "Requires Biotech", Category = "Colonists" , Description = "A new Yttakin recruit joins the colony with the player's primary ideology.", Price = 150 },
        ...
        new("Void Provocation", "triggerincident_VoidCuriosity") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger the Void Curiosity incident that begins the path toward void provocation.", Price = 150 },
        new("Creepy Joiner Event", "triggerquest_CreepJoinerArrival") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger a creepy joiner arrival quest.", Price = 200 },
        new("Random Monolith Event", "randommonolithevent") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger a random monolith-related anomaly event.", Price = 200 },
        new("Receive Unknown Cargo Quest", "triggerincident_ResourcePodCrash") { Category = "Event" , Description = "Trigger a cargo pod crash near the colony.", Price = 100 },
        new("Deathpall", "triggerincident_DeathPall") { Note = "Requires Anomaly", Category = "Event" , Description = "Trigger the deathpall event.", Price = 300 },
